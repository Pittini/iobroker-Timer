const SkriptVersion = "2.1.7"; //Stand 26.07.2020 - Github: https://github.com/Pittini/iobroker-Timer Forum: https://forum.iobroker.net/topic/33228/vorlage-flexibles-timerskript-vis
            ...
            if (Funktion == WelcheFunktionVerwenden) { //Wenn Function ist z.B. TimerTarget
                for (let y in members) { // Loop über alle TimerTarget Members
                    ...
                    if (UseChannelNames) {
                        ...
                        TargetNames[y] = getObject(Targets[y], "common").common.name;
                    }
                };
