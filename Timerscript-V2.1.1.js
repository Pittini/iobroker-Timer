const SkriptVersion = "2.1.1"; //Stand 18.06.2020 - Github: https://github.com/Pittini/iobroker-Timer Forum: https://forum.iobroker.net/topic/33228/vorlage-flexibles-timerskript-vis
...
const Dps = ["Aktiv", "Rolle", "TimerTimestamp", "TimerAstroTimestamp", "TimerAstroShift", "TimerChoice", "TimerSonntag", "TimerMontag", "TimerDienstag", "TimerMittwoch", "TimerDonnerstag", "TimerFreitag", "TimerSamstag", "SwitchTarget", "OnlyIfPresence", "OnlyIfNoPresence", "ActivityMessage", "SwitchTargetSmartName"];
...
function FillTimerArray(x) { //Erzeugt TimerArray. Aufruf bei Start und AddTimer
    ...
    if (MyTimer[x][17] == "") { //Wenn Smartname nicht vorhanden, auf default setzen
        MyTimer[x][17] = getObject(GetParentId(MyTimer[x][13]), "common").common.name
...
function init() {
    ...
    //       10              11                  12              13              14              15                  16           	17  		 18 (+0)       19 (+1)   20 (+2)    21 (+3)
    // "TimerDonnerstag", "TimerFreitag", "TimerSamstag", "SwitchTarget", "OnlyIfPresence", "OnlyIfNoPresence","ActivityMessage","SmartName","TabellenStatus", "IsEdit","unused","TimerAktion"
